...
//		System.out.println(next.getText());
		assertNotNull(next);
		assertNotNull(title);
		assertEquals(55, Integer.parseInt(next.getText()));
	}
	...
	public void participateIfOpen() throws Exception
	{
		...
		for(WebElement span: spans){
			WebElement participant = span.findElement(By.xpath("../following-sibling::div/button[.='Participate']"));
			participant.click();
		}
	}
	...
	public void amazonImage() throws Exception
	{
		...
		String str= title.findElement(By.xpath("../following-sibling::div//span/img[@src='/media/amazongc-micro.jpg']")).getAttribute("src");
				
		assertNotNull(str);
		assert(str.equals("http://www.checkbox.io/media/amazongc-micro.jpg"));
